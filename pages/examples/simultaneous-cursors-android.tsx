...
const SimultaneousCursorsAndroidExampleView: NextPage = () => {
  return (
    <ExampleLayout breadcrumbTitle={exampleTitle}>
      {() => (
        <>
          ...
          <VideoPlayer videoSrc="/assets/videos/examples/android-simultaneous-cursors.mp4" />
        </>
      )}
    </ExampleLayout>
  );
...
export default SimultaneousCursorsAndroidExampleView;

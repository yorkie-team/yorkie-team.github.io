...
- `syncMode` (Optional): Specifies the synchronization mode. The default value is `SyncMode.realtime`, which automatically pushes and pulls changes. If you set it to `SyncMode.manual`, you must handle synchronization manually.

...
If clients are connected to Yorkie cluster with `userID`([Mesasuring MAU](/docs/js-sdk#measuring-mau)), you can see the user events are collected in StarRocks database.

...
| Component | Role |
|-----------|------|
| **Root** | The source of truth -- the actual CRDT data of the document. It can only be updated by applying [Changes](/docs/sdks/js-sdk#editing-the-document). |
...
For the full SDK reference, see [Synchronization Modes](/docs/sdks/js-sdk#synchronization-modes).

### PushPullChanges

**PushPullChanges** is the core synchronization API that enables bidirectional exchange of [Changes](/docs/sdks/js-sdk#editing-the-document) between a client and the server. Each sync cycle involves:
...
These events power the [Presence](/docs/sdks/js-sdk#presence) system, enabling features like showing who's online and tracking cursor positions.
